const tokens = {
  ...
  "colors.blueBasic": {
    "value": "#3692FF",
    "variable": "var(--colors-blue-basic)"
  },
  "colors.blueBanner": {
    "value": "#CFE5FF",
    "variable": "var(--colors-blue-banner)"
  },
  "colors.textBasic": {
    "value": "#374151",
    "variable": "var(--colors-text-basic)"
  },
  "colors.disabledBasic": {
    "value": "#9CA3AF",
    "variable": "var(--colors-disabled-basic)"
  },
  "fonts.sans": {
